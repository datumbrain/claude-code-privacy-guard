 ...
 */
export function writeAllowlists(
  configPath: string,
  allowlists: { allowedDomains: string[]; allowedValues: string[]; allowedPatterns: string[] }
): void {
...
export function writeConfigKeys(configPath: string, keys: Record<string, unknown>): void {
